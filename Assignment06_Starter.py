...
# MDunn,8.9.2023,Updated code to finish project
# ---------------------------------------------------------------------------- #
...
# Step 1 - When the program starts, Load data from ToDoFile.txt. If no text file currently exists
# then it will let the user know to add some tasks
try:
    Processor.read_data_from_file(file_name=file_name_str, list_of_rows=table_lst)  # read file data
except:
    print('There is currently no ToDo List file saved. Please add some tasks!', '\n')
